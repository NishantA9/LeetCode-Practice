...
class RandomizedSet:
    ...
    def __init__(self):
        # Initialize an empty dictionary to store the values and their corresponding indices in the list
        self.numMap = {}  
        # Initialize an empty list to store the values in the set
        self.numList = []  

    def insert(self, val: int) -> bool:
        # Check if the value is not already in the set (i.e., not in the dictionary)
        res = val not in self.numMap  
        if res:
            # If the value is not in the set, add it to the dictionary with its index in the list
    ...
    def remove(self, val: int) -> bool:
        # Check if the value is in the set (i.e., in the dictionary)
        ...
        if res:
            ...
            self.numList.pop()  
            # Update the dictionary to reflect the new index of the last value
